#!/usr/bin/env python3
"""Install Android platform-tools into backend runtime directory."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Install official Android platform-tools for backend runtime.")
    parser.add_argument(
        "--install-root",
